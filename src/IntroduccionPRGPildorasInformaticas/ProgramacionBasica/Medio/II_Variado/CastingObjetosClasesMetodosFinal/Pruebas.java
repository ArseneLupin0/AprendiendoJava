...
//#############################################################################
    public static void main(String[] args) {
        ...
        Jefatura jefaFinanzas = (Jefatura) misEmpleados[5]; // Castear un objeto de tipo Empleados a Jefatura
//        Jefatura jefaCompras = (Jefatura) misEmpleados[0]; // Fallará ya que un empleado no siempre es un jefe

        // Lo haremos para obtener los métodos que tenemos en jefatura
